...
import { createCategoryAction } from "../admin-dashboard/_actions/adminActions";

interface LandlordCategoriesClientProps {
  user: any;
}

export default function LandlordCategoriesClient({ user }: LandlordCategoriesClientProps) {
